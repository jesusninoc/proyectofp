...
class CourseResourceIT {
    ...
    public static Course createEntity(EntityManager em) {
        Course course = new Course().name(DEFAULT_NAME).description(DEFAULT_DESCRIPTION).image(DEFAULT_IMAGE);
        return course;
    }
    ...
    public static Course createUpdatedEntity(EntityManager em) {
        Course course = new Course().name(UPDATED_NAME).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
        return course;
    }
    ...
    void putNewCourse() throws Exception {
        ...
        updatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
    ...
    void partialUpdateCourseWithPatch() throws Exception {
        ...
        partialUpdatedCourse.name(UPDATED_NAME).description(UPDATED_DESCRIPTION).image(UPDATED_IMAGE);
