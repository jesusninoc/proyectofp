...
class AdminResourceIT {
    ...
    public static Admin createEntity(EntityManager em) {
        Admin admin = new Admin().username(DEFAULT_USERNAME).password(DEFAULT_PASSWORD).name(DEFAULT_NAME).lastname(DEFAULT_LASTNAME);
        return admin;
    }
    ...
    public static Admin createUpdatedEntity(EntityManager em) {
        Admin admin = new Admin().username(UPDATED_USERNAME).password(UPDATED_PASSWORD).name(UPDATED_NAME).lastname(UPDATED_LASTNAME);
        return admin;
    }
    ...
    void createAdmin() throws Exception {
        ...
        assertThat(testAdmin.getLastname()).isEqualTo(DEFAULT_LASTNAME);
    }
    ...
    void putNewAdmin() throws Exception {
        ...
        updatedAdmin.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).name(UPDATED_NAME).lastname(UPDATED_LASTNAME);
        ...
        assertThat(testAdmin.getLastname()).isEqualTo(UPDATED_LASTNAME);
    }
    ...
    void partialUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.name(UPDATED_NAME);
    ...
    void fullUpdateAdminWithPatch() throws Exception {
        ...
        partialUpdatedAdmin.username(UPDATED_USERNAME).password(UPDATED_PASSWORD).name(UPDATED_NAME).lastname(UPDATED_LASTNAME);
