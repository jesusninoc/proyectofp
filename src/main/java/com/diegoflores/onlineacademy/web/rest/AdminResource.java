...
import com.diegoflores.onlineacademy.repository.AdminRepository;
import com.diegoflores.onlineacademy.service.AdminService;
...
/**
 * REST controller for managing {@link com.diegoflores.onlineacademy.domain.Admin}.
 */
@RestController
@RequestMapping("/api")
public class AdminResource {
     ...
     */
    @GetMapping("/admins")
    public ResponseEntity<List<Admin>> getAllAdmins(Pageable pageable) {
